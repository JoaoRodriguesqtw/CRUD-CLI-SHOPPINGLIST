...
while True:
    ...
    print("--Digite 4 para vizualizar a lista--")
    print("--Digite 5 para vizualizar o valor total--")
    ...
    if li_opcao_escolhida == 1:
        ...
        if (len(ls_lista_compras)) <= 0:
            ...
            for x in range (len(ls_lista_compras)):
                ...
                print(f"--{ls_item.capitalize()}: {li_quantidade} unidades {((lf_valor_compras)*(li_quantidade)):.2f} Reais ao total  ")
            print()
